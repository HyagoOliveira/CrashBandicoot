...
/*!
 * @king/uv-scene v2.1.3
 * Copyright(C) King, 2020 
 */
function o(){}function i(e){var t,n=!1;return function(){return n||(t=e(),n=!0),t}}n.r(t),n.d(t,"Scene",(function(){return h})),n.d(t,"SceneManager",(function(){return m})),n.d(t,"helpers",(function(){return p}));var r,s,a=function(e){var t=0;return{hangFire:function(e){return t++,void 0===e&&(e=o),function(){var n;try{n=e()}catch(e){}return t--,n}},call:function(n){n=void 0===n?6e3:n;var o=Date.now(),i=setInterval((function(){if(t<=0||n<=Date.now()-o)return clearInterval(i),e()}),200)}}},u=(r=function(){var e,t=document.createElement("fake"),n={animation:"animationend",OAnimation:"oAnimationEnd",MozAnimation:"animationend",WebkitAnimation:"webkitAnimationEnd"};for(e in n)if(void 0!==t.style[e])return n[e]},function(){return void 0!==s?s:s=r()})(),d={SHOWING:"rendering",SHOWED:"rendered",HIDING:"hiding",HIDDEN:"hidden"},l={HIDE:"hidden",SHOW:"show"};function c(e){return function(t,n){n=void 0===n?1500:n;var o=void 0,i=function(e){void 0!==o&&clearInterval(o),t()};o=setTimeout((function(){e.removeEventListener(u,i),t()}),n),e.addEventListener(u,i,{once:!0})}}function _(e,t){if(Object.prototype.hasOwnProperty.call(e,"length"))for(var n=0;n<e.length;n++)t(e[n],n);else for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t(e[o],o)}var p=Object.freeze({__proto__:null,noop:o,once:i,DelayedAction:a,Events:d,Classes:l,afterAnimationOf:c,forEach:_});function f(e,t){Object.hasOwnProperty.call(e.listeners,t)&&_(e.listeners[t],(function(t){t(e)}))}var h=function(e,t,n,o){if(t=void 0===t?{}:t,n=void 0===n?[]:n,o=void 0===o?{}:o,this._initialized=!1,this._renderized=!1,this.node=e,!(this.node instanceof Element))throw new Error("The scene needs at least one valid node.");this.animationDelay=o.animationDelay||100,this.stopEmissionsOnResize=!Object.hasOwnProperty.call(o,"stopEmissionsOnResize")||o.stopEmissionsOnResize,this.bindings=n,this.listeners=[],this.animators=[],this.nativeAppInfo=t;var i=this;this.triggerHiddenAction=new a((function(){f(i,d.HIDDEN),i.listeners=[]})),this.animatedNodes=this.node.querySelectorAll("[data-animation]")};h.prototype.setup=function(){var e=this;_(this.bindings,(function(t){var n=e.node.querySelector(t.selector);null!==n&&(t.listener={handleEvent:function(n){t.fn(e,n)}},_(["click","tap"],(function(e){n.addEventListener(e,t.listener)})))}))},h.prototype.isInitialized=function(){return this._initialized},h.prototype.hasBeenRenderized=function(){return this._renderized},h.prototype.isVisible=function(){return this.hasBeenRenderized()},h.prototype.show=function(){if(this.isInitialized()||(this.setup(),this._initialized=!0),!this._renderized){var e=this;return setTimeout((function(){f(e,d.SHOWING),e.node.classList.remove(l.HIDE),e.node.classList.add(l.SHOW),_(e.animatedNodes,(function(e){e.classList.add(e.dataset.animation)})),_(e.animators,(function(e){e.start()})),e._renderized=!0,"none"!==window.getComputedStyle(e.node).animationName?c(e.node)((function(){f(e,d.SHOWED)})):f(e,d.SHOWED)}),this.animationDelay)}},h.prototype.hide=function(e){var t=this;f(t,d.HIDING),_(t.animatedNodes,(function(e){e.classList.remove(e.dataset.animation)})),_(t.animators,(function(e){e.stop()})),_(t.bindings,(function(e){var n=t.node.querySelector(e.selector);_(["click","tap"],(function(t){n.removeEventListener(t,e.listener)}))})),t.node.classList.add(l.HIDE),t.node.classList.remove(l.SHOW),t._initialized=!1,t._renderized=!1,""!==window.getComputedStyle(t.node).getPropertyValue("animation")&&c(t.node)(this.triggerHiddenAction.hangFire()),this.triggerHiddenAction.call(e)},h.prototype.subscribe=function(e,t){Object.hasOwnProperty.call(this.listeners,e)||(this.listeners[e]=[]),this.listeners[e].push(t)},h.prototype.isSoundActivated=function(){return!!(e=this.nativeAppInfo)&&!!e.detail&&!!e.detail.shouldPlayAudio;var e},h.prototype.setAudioPlayer=function(e){this.audioPlayer=e,this.isSoundActivated()&&this.audioPlayer.load()},h.prototype.playSound=function(e,t){if(void 0===t&&(t=o),Object.hasOwnProperty.call(this,"audioPlayer")&&this.isSoundActivated()){var n=i(t);try{this.audioPlayer.play(e,n)}catch(e){console.error(e),n()}}else t()},h.prototype.playSoundOnShow=function(e){var t=this;t.subscribe(d.SHOWING,(function(){t.playSound(e)}))},h.prototype.playSoundOnHide=function(e){var t=this;t.subscribe(d.HIDING,(function(){t.playSound(e,t.triggerHiddenAction.hangFire())}))};var m=function(){this.scenes={}};m.prototype.addScene=function(e,t){if(Object.hasOwnProperty.call(this.scenes,e))throw Error('The scene "'+e+'" already exists in the SceneManager.');this.scenes[e]=t},m.prototype.hideScene=function(e){this.getScene(e).hide()},m.prototype.getScene=function(e){if(!Object.hasOwnProperty.call(this.scenes,e))throw Error('The scene "'+e+'" does not exists in the SceneManager.');return this.scenes[e]},m.prototype.showScene=function(e,t){t=void 0===t||t;var n=Object.hasOwnProperty.call(this.scenes,e)?this.scenes[e]:void 0;if(void 0===n)throw new Error("The scene is not registered on the Scene Manager.");var o=[];for(var i in this.scenes)if(Object.hasOwnProperty.call(this.scenes,i)){var r=this.scenes[i];r.isVisible()&&t?r.hide():r.isVisible()&&o.push(r)}o.forEach((function(e){setTimeout((function(){e.hide()}),n.animationDelay)})),n.show()}},function(e,t,n){"use strict";n.r(t),n.d(t,"AudioPlayer",(function(){return i}));
/*!
 * @king/uv-audio v2.1.3
 * Copyright(C) King, 2020 
 */
var o=n(6).Howl,i=function(e,t){this.config={audios:e,sprite:t},this.audioLib=null};i.prototype.load=function(){this.audioLib=new o({src:this.config.audios,sprite:this.config.sprite,preload:!0,pool:3})},i.prototype.play=function(e,t){this.audioLib&&this.audioLib.once("end",t,e).play(e)}},function(e,t,n){(function(n){var o;
/*!
 *  howler.js v2.1.3
 *  howlerjs.com
 *
